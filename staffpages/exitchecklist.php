                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <form  role="form" action="processexit.php?eid=<?php echo $_GET['eid'];?>" method="post">
                                    ...
                                    <div class="box-body" >
                                        ...
                                        $checklist_result = mysql_query("select * from checklist_exit_entry where departmentId = '".$_SESSION['$departmentId']."';");
